...
BdData<-read.csv(file.choose(), header=TRUE) # File name: "Experiment1&2CombinedBdInfectionData"
head(BdData)
...
#sort(unique(BdTemp$TimeSinceExposure))
...
plots<-{
  ...
  #par(mfrow=c(2,3))
  #par(mar=c(4,5,1,1))
  plot(x=c(10,15,20,25),y=a10d0pc,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="Ln Bd load +1", main="Day 35 Infection Curve")
...
###############################################
# 
# TempModel1.0<-lmer(LnSwabBd~AccTemp*PerfTemp*Experiment+(1|AccInc),data=subset(BdTemp,TimeSinceExposure=="7"))
...
# TempModel1.1<-lm(LnSwabBd~AccTemp*PerfTemp,data=subset(IndBd2021,TimeSinceExposure=="7" & DayOfExpo==0))
# summary(TempModel1.1)
# Anova(TempModel1.1,test="F")
# 
# #Look at 2022.IndBd2022 second.
# TempModel1.2<-lm(LnSwabBd~AccTemp*PerfTemp,data=subset(IndBd2022,TimeSinceExposure=="7" & DayOfExpo==0))
# summary(TempModel1.2)
# Anova(TempModel1.2,test="F")
# 
# #
# TempModel1.3<-lmer(LnSwabBd~AccTemp*PerfTemp+TimeSinceExposure+Experiment+(1|FrogID),data=subset(BdTemp,TimeSinceExposure>3)) 
...
TempModel1.4<-lmer(LnSwabBd~AccTemp*PerfTemp*TimeSinceExposure+(1|PerfInc/FrogID)+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
...
TempModel1.4<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*PerfTemp + PerfTemp*TimeSinceExposure + AccTemp*TimeSinceExposure+(1|PerfInc/FrogID)+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.4)

# PerfTemp coefficient
TempModel1.4<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*TimeSinceExposure+(1|PerfInc/FrogID)+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.4)

# AccTemp coefficient
TempModel1.4<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + PerfTemp*TimeSinceExposure+(1|PerfInc/FrogID)+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.4)

# TimeSinceExposure coefficient
TempModel1.4<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*PerfTemp+(1|PerfInc/FrogID)+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.4)

# TempModel1.5<-lmer(LnSwabBd~AccTemp*PerfTemp+TimeSinceExposure+(1|FrogID),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
...
# 
# TempModel1.6<-lmer(LnSwabBd~AccTemp*PerfTemp+PerfTemp*TimeSinceExposure+AccTemp*TimeSinceExposure+(1|FrogID),data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0)) 
...
TempModel1.7<-lmer(LnSwabBd~AccTemp*PerfTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.7)
Anova(TempModel1.7,test="F")
#View(Anova(TempModel1.7,test="F")) #View() gives table

# 2-way interactions coefficients
TempModel1.7<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*PerfTemp + PerfTemp*TimeSinceExposure + AccTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.7)

# PerfTemp coefficient
TempModel1.7<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.7)

# AccTemp coefficient
TempModel1.7<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + PerfTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.7)

# TimeSinceExposure coefficient
TempModel1.7<-lmer(LnSwabBd~AccTemp + PerfTemp + TimeSinceExposure + AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc/FrogID),data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0)) 
summary(TempModel1.7)
...
TimeModel1.0<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure=="7" & DayOfExpo==0))
summary(TimeModel1.0)
Anova(TimeModel1.0,test="F")
#View(Anova(TimeModel1.0,test="F"))

TimeModel1.1<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure=="14" & DayOfExpo==0))
summary(TimeModel1.1)
Anova(TimeModel1.1,test="F")
#View(Anova(TimeModel1.1,test="F"))

TimeModel1.2<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure=="21" & DayOfExpo==0))
summary(TimeModel1.2)
Anova(TimeModel1.2,test="F")
#View(Anova(TimeModel1.2,test="F"))

TimeModel1.3<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure=="28" & DayOfExpo==0))
summary(TimeModel1.3)
Anova(TimeModel1.3,test="F")
#View(Anova(TimeModel1.3,test="F"))

TimeModel1.4<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc),data=subset(IndBd2021,TimeSinceExposure=="35" & DayOfExpo==0))
...
TimeModel2.0<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc),data=subset(IndBd2022,TimeSinceExposure=="7" & DayOfExpo==0))
summary(TimeModel2.0)
Anova(TimeModel2.0,test="F")
#View(Anova(TimeModel2.0,test="F"))

TimeModel2.1<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc),data=subset(IndBd2022,TimeSinceExposure=="14" & DayOfExpo==0))
summary(TimeModel2.1)
Anova(TimeModel2.1,test="F")
#View(Anova(TimeModel2.1,test="F"))

TimeModel2.2<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc),data=subset(IndBd2022,TimeSinceExposure=="21" & DayOfExpo==0))
summary(TimeModel2.2)
Anova(TimeModel2.2,test="F")
#View(Anova(TimeModel2.2,test="F"))

TimeModel2.3<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc),data=subset(IndBd2022,TimeSinceExposure=="28" & DayOfExpo==0))
summary(TimeModel2.3)
Anova(TimeModel2.3,test="F")
#View(Anova(TimeModel2.3,test="F"))

TimeModel2.4<-lmer(LnSwabBd~AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc),data=subset(IndBd2022,TimeSinceExposure=="35" & DayOfExpo==0))
...
Day7Bd21<-subset(IndBd2021,TimeSinceExposure=="7" & DayOfExpo==0)
Day7Bd22<-subset(IndBd2022,TimeSinceExposure=="7" & DayOfExpo==0)
...
Expo2021.6<-lmer(LnSwabBd~AccTemp*PerfTemp * TimeSinceExposure +(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)
Anova(Expo2021.6,test="F")
#View(Anova(Expo2021.6,test="F"))

# 2-way interactions coefficients
Expo2021.6<-lmer(LnSwabBd~AccTemp*PerfTemp + AccTemp*TimeSinceExposure + PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)

# PerfTemp coefficient
Expo2021.6<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)

# TimeSinceExposure coefficient
Expo2021.6<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)

# AccTemp coefficient
Expo2021.6<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + PerfTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)

### DayOfExpo=0 Full model
Expo2021.7<-lmer(LnSwabBd~AccTemp*PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)
Anova(Expo2021.7,test="F")
#View(Anova(Expo2021.7,test="F"))

# 2-way interactions coefficients
Expo2021.7<-lmer(LnSwabBd~AccTemp*PerfTemp + AccTemp*TimeSinceExposure + PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)

# PerfTemp coefficient
Expo2021.7<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)

# TimeSinceExposure coefficient
Expo2021.7<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)

# AccTemp coefficient
Expo2021.7<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)

### DayOfExpo=7 Full model
Expo2021.8<-lmer(LnSwabBd~AccTemp*PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.8)
...
# 2-way interactions coefficients
Expo2021.8<-lmer(LnSwabBd~AccTemp*PerfTemp + AccTemp*TimeSinceExposure + PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.8)

# PerfTemp coefficient
Expo2021.8<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.8)

# TimeSinceExposure coefficient
Expo2021.8<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + AccTemp*PerfTemp+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.8)

# AccTemp coefficient
Expo2021.8<-lmer(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure + PerfTemp * TimeSinceExposure+(1|AccInc)+(1|PerfInc/FrogID),
                 data=subset(IndBd2021,DayOfExpo== 7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.8)
# 
# # Backward selection:
# # remove 3-way interaction
# Expo2021.8<-lm(LnSwabBd~AccTemp*PerfTemp + AccTemp*TimeSinceExposure + PerfTemp * TimeSinceExposure,
#                data=subset(IndBd2021, DayOfExpo== 7 & TimeSinceExposure<=14 & (PerfTemp==10|PerfTemp==20)))
# Anova(Expo2021.8,test="F")
# Expo2021.8<-lm(LnSwabBd~AccTemp*PerfTemp + PerfTemp * TimeSinceExposure,
#                data=subset(IndBd2021, DayOfExpo== 7 & TimeSinceExposure<=14 & (PerfTemp==10|PerfTemp==20)))
# Anova(Expo2021.8,test="F")
# Expo2021.8<-lm(LnSwabBd~AccTemp+PerfTemp+TimeSinceExposure+ PerfTemp * TimeSinceExposure,
#                data=subset(IndBd2021, DayOfExpo== 7 & TimeSinceExposure<=14 & (PerfTemp==10|PerfTemp==20)))
# Anova(Expo2021.8,test="F")
...
#                data=subset(IndBd2022,TimeSinceExposure==7 & DayOfExpo==0))
# summary(Expo2022.1)
...
#                data=subset(IndBd2022,TimeSinceExposure==42 & DayOfExpo==-35))
# summary(Expo2022.2)
# Anova(Expo2022.2,test="F")
# #View(Anova(Expo2022.2,test="F"))
#
# Expo2022.1<-lm(LnSwabBd~AccTemp,
#                   data=subset(IndBd2022, (TimeSinceExposure==6 & DayOfExpo==-35)))
# summary(Expo2022.1)
# Anova(Expo2022.1,test="F")
# 
# Expo2022.2<-lm(LnSwabBd~PerfTemp,
#                   data=subset(IndBd2022,(TimeSinceExposure==7 & DayOfExpo==0 & (PerfTemp==10|PerfTemp==20))))
# summary(Expo2022.2)
# Anova(Expo2022.2,test="F")
...
### DayOfExpo=-7; TimeSinceExposure==7
Expo2021.6<-lm(LnSwabBd~AccTemp,
               data=subset(IndBd2021,DayOfExpo== -7 & TimeSinceExposure==7  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.6)
Anova(Expo2021.6,test="F")
#View(Anova(Expo2021.6,test="F"))
...
### DayOfExpo=-7; TimeSinceExposure==14
...
### DayOfExpo=0; TimeSinceExposure==7
Expo2021.7<-lmer(LnSwabBd~AccTemp*PerfTemp + (1|AccInc),
                 data=subset(IndBd2021,DayOfExpo== 0 & TimeSinceExposure==7  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)
Anova(Expo2021.7,test="F")
#View(Anova(Expo2021.7,test="F"))

### DayOfExpo=0; TimeSinceExposure==14
Expo2021.7<-lmer(LnSwabBd~AccTemp*PerfTemp + (1|AccInc),
                 data=subset(IndBd2021,DayOfExpo== 0 & TimeSinceExposure==14  & (PerfTemp==10|PerfTemp==20)))
summary(Expo2021.7)
Anova(Expo2021.7,test="F")
#View(Anova(Expo2021.7,test="F"))
...
Expo2021Mn<-tapply(IndBd2021$LnSwabBd, list(IndBd2021$TimeSinceExposure,IndBd2021$AccTemp,IndBd2021$PerfTemp, IndBd2021$DayOfExpo), mean)
Expo2021SDevs<-tapply(IndBd2021$LnSwabBd, list(IndBd2021$TimeSinceExposure,IndBd2021$AccTemp,IndBd2021$PerfTemp, IndBd2021$DayOfExpo), sd)
Expo2021Counts<-tapply(IndBd2021$LnSwabBd, list(IndBd2021$TimeSinceExposure,IndBd2021$AccTemp,IndBd2021$PerfTemp, IndBd2021$DayOfExpo), length)
Expo2021SEs<-Expo2021SDevs/sqrt(Expo2021Counts)

Expo2022Mn<-tapply(IndBd2022$LnSwabBd, list(IndBd2022$TimeSinceExposure, IndBd2022$AccTemp, IndBd2022$PerfTemp, IndBd2022$DayOfExpo), mean)
Expo2022SDevs<-tapply(IndBd2022$LnSwabBd, list(IndBd2022$TimeSinceExposure, IndBd2022$AccTemp, IndBd2022$PerfTemp, IndBd2022$DayOfExpo), sd)
Expo2022Counts<-tapply(IndBd2022$LnSwabBd, list(IndBd2022$TimeSinceExposure, IndBd2022$AccTemp, IndBd2022$PerfTemp, IndBd2022$DayOfExpo), length)
Expo2022SEs<-Expo2022SDevs/sqrt(Expo2022Counts)

#tapply is [TimeSinceExposure,AccTemp,PerfTemp,DayOfExpo]

### 2021 PLOTS
par(mfrow=c(3,2),mar=c(5,5,3,1))
#2021, ExpoDay=0, TimeSinceExposure=7, AccTemp=10
plot(x=c(10,15,20,25),y=Expo2021Mn[4,1,1:4,2],
     main="IndBd2021 Day 0 Exposure (TimeSinceExposure=7,Acc=10)",col="white",ylim=c(0,7))
...
#2021, ExpoDay=0, TimeSinceExposure=7, AccTemp=20
...
#2022, ExpoDay=0, TimeSinceExposure=7, AccTemp=10
plot(x=c(10,15,20,25),y=Expo2021Mn[4,1,1:4,1],
     main="IndBd2022 Day 0 Exposure (TimeSinceExposure=7,Acc=10)",col="white",ylim=c(0,7))
...
#2022, ExpoDay=0, TimeSinceExposure=7, AccTemp=15
...
#2022, ExpoDay=0, TimeSinceExposure=7, AccTemp=20
...
#2021, ExpoDay=-7, TimeSinceExposure=7, AccTemp=10
plot(x=c(10,15,20,25),y=Expo2021Mn[4,1,1:4,1],
     main="IndBd2021 Day -7 Exposure (TimeSinceExposure=7,Acc=10)",col="white",ylim=c(0,7))
...
#2021, ExpoDay=-7, TimeSinceExposure=7, AccTemp=20
...
plot(x=c(perfTemp.df[1,1:4]),y=a10d0pcBd21,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#,main="Bd 2021")
...
legend("topright",title="AccTemp",c("10 °C","20 °C"),col=c(col[1],col[3]),pch=c(0,1),lty=c(1,3),cex=1.25,bty="n")
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#,main="Bd 2022")
...
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,col=col[2],lwd=2,lty=2)
...
axis(1,at=seq(from=10,to=25,by=5),labels=FALSE,tick=TRUE)
legend("topright",title="AccTemp",c("10 °C","15 °C","20 °C"),col=col,pch=c(0,2,1),lty=c(1,2,3),cex=1.25,bty="n")
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 14 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,yplus=a10d0pcBd21+se10d0pcBd21,yminus=a10d0pcBd21-se10d0pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,yplus=a20d0pcBd21+se20d0pcBd21,yminus=a20d0pcBd21-se20d0pcBd21,col=col[3],errbar.col=col[3],pch=1,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,col=col[3],lwd=2,lty=3)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 14 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,yplus=a10d0pcBd22+se10d0pcBd22,yminus=a10d0pcBd22-se10d0pcBd22,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,yplus=a15d0pcBd22+se15d0pcBd22,yminus=a15d0pcBd22-se15d0pcBd22,col=col[2],errbar.col=col[2],pch=2,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,col=col[2],lwd=2,lty=2)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 21 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,yplus=a10d0pcBd21+se10d0pcBd21,yminus=a10d0pcBd21-se10d0pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,yplus=a20d0pcBd21+se20d0pcBd21,yminus=a20d0pcBd21-se20d0pcBd21,col=col[3],errbar.col=col[3],pch=1,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,col=col[3],lwd=2,lty=3)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 21 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,yplus=a10d0pcBd22+se10d0pcBd22,yminus=a10d0pcBd22-se10d0pcBd22,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,yplus=a15d0pcBd22+se15d0pcBd22,yminus=a15d0pcBd22-se15d0pcBd22,col=col[2],errbar.col=col[2],pch=2,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,col=col[2],lwd=2,lty=2)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 28 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,yplus=a10d0pcBd21+se10d0pcBd21,yminus=a10d0pcBd21-se10d0pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,yplus=a20d0pcBd21+se20d0pcBd21,yminus=a20d0pcBd21-se20d0pcBd21,col=col[3],errbar.col=col[3],pch=1,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,col=col[3],lwd=2,lty=3)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')#, main="Day 28 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,yplus=a10d0pcBd22+se10d0pcBd22,yminus=a10d0pcBd22-se10d0pcBd22,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,yplus=a15d0pcBd22+se15d0pcBd22,yminus=a15d0pcBd22-se15d0pcBd22,col=col[2],errbar.col=col[2],pch=2,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,col=col[2],lwd=2,lty=2)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5)#, main="Day 35 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,yplus=a10d0pcBd21+se10d0pcBd21,yminus=a10d0pcBd21-se10d0pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,yplus=a20d0pcBd21+se20d0pcBd21,yminus=a20d0pcBd21-se20d0pcBd21,col=col[3],errbar.col=col[3],pch=1,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a20d0pcBd21,col=col[3],lwd=2,lty=3)
...
plot(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col="white",xlim=c(10,25),ylim=c(0,7),xlab="Temperature (°C)",ylab="",cex.axis=1.5,cex.lab=1.5,cex.main=1.5)#, main="Day 35 Infection Curve")
errbar(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,yplus=a10d0pcBd22+se10d0pcBd22,yminus=a10d0pcBd22-se10d0pcBd22,col=col[1],errbar.col=col[1],pch=0,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[1,1:4])),y=a10d0pcBd22,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,yplus=a15d0pcBd22+se15d0pcBd22,yminus=a15d0pcBd22-se15d0pcBd22,col=col[2],errbar.col=col[2],pch=2,cex=2.75,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(perfTemp.df[2,1:4])),y=a15d0pcBd22,col=col[2],lwd=2,lty=2)
...
mtext("Performance temperature (°C)",side=1,line=1,cex=1.5,outer=TRUE)
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=dm7AccTempBd21Mn,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",cex.lab=1.25,cex.axis=1.5,xaxt='n')#, main="Day 35 Infection Curve")
...
axis(1,at=seq(from=10,to=20,by=10),labels=FALSE,tick=TRUE)
...
box(col="white",lwd=3)
title("Exposure day: +7",line=1,cex.main=1.6,xpd=NA)
text(x=22.5,y=3.5,"Day 0",xpd=NA,srt=270,cex=1.2)
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=a10dm7pcBd21,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",cex.axis=1.5,xaxt='n')#, main="Day 7 Infection Curve")
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=a10d0pcBd21,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",cex.lab=1.5,cex.axis=1.5,xaxt='n')#, main="Day 7 Infection Curve")
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),xlim=c(9,21),y=c(0,7),col="white",xaxt='n',yaxt='n',ylab="",xlab="") #blank
legend(x=11,y=7.8,title="AccTemp",c("10 °C","20 °C"),col=c(col[1],col[3]),pch=c(0,1),lty=c(1,3),bty="n",cex=1.5)
box(col="white",lwd=3)
text(x=22.5,y=3.5,"Day 7",xpd=NA,srt=270,cex=1.2)

mtext(paste("Temperature shift"),side=3,line=-10,cex=1.2,adj=0.5,outer=TRUE)
mtext(paste("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"),side=3,line=-11,cex=1.2,outer=TRUE)
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=a10dp7pcBd21,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",,cex.lab=1.5,cex.axis=1.5,xaxt='n')#,main="7 Days Post Exposure")
...
axis(1,at=seq(from=10,to=20,by=10),labels=FALSE,tick=TRUE)
box(col="darkgray",lwd=3)
text(x=22.5,y=3.5,"Day 14",xpd=NA,srt=270,cex=1.2)
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=a10d0pcBd21,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",cex.axis=1.5,xaxt='n')#, main="Day 14 Infection Curve")
errbar(x=c(as.numeric(accTemp.df[1,1:2])),y=a10d0pcBd21,yplus=a10d0pcBd21+se10d0pcBd21,yminus=a10d0pcBd21-se10d0pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(accTemp.df[1,1:2])),y=a10d0pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(accTemp.df[2,1:2])),y=a20d0pcBd21,yplus=a20d0pcBd21+se20d0pcBd21,yminus=a20d0pcBd21-se20d0pcBd21,col=col[3],errbar.col=col[3],pch=1,cex=2,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(accTemp.df[2,1:2])),y=a20d0pcBd21,col=col[3],lwd=2,lty=3)
...
plot(x=c(as.numeric(accTemp.df[1,1:2])),y=a10dp7pcBd21,col="white",xlim=c(9,21),ylim=c(0,7),xlab="",ylab="",cex.axis=1.5,xaxt='n')#,main="14 Days Post Exposure")
errbar(x=c(as.numeric(accTemp.df[1,1:2])),y=a10dp7pcBd21,yplus=a10dp7pcBd21+se10dp7pcBd21,yminus=a10dp7pcBd21-se10dp7pcBd21,col=col[1],errbar.col=col[1],pch=0,cex=2,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(accTemp.df[1,1:2])),y=a10dp7pcBd21,col=col[1],lwd=2,lty=1)
errbar(x=c(as.numeric(accTemp.df[2,1:2])),y=a20dp7pcBd21,yplus=a20dp7pcBd21+se20dp7pc,yminus=a20dp7pcBd21-se20dp7pc,col=col[3],errbar.col=col[3],pch=1,cex=2,cex.lab=1.5,cex.main=1.5,add=TRUE)
lines(x=c(as.numeric(accTemp.df[2,1:2])),y=a20dp7pcBd21,col=col[3],lwd=2,lty=3)
...
axis(1,at=seq(from=10,to=20,by=10),labels=FALSE,tick=TRUE)
box(col="black",lwd=3)
text(x=22.5,y=3.5,"Day 21",xpd=NA,srt=270,cex=1.2)
...
axis(1,at=seq(from=10,to=20,by=10),labels=FALSE,tick=TRUE)
#box(col="darkorange",lwd=2)
text(x=22.5,y=3.5,"Day 28",xpd=NA,srt=270,cex=1.2)
...
axis(1,at=seq(from=10,to=20,by=10),cex.axis=1.5,labels=TRUE,tick=TRUE)
#box(col="darkorange",lwd=2)
...
mtext(expression(paste("Ln(Bd Z"["e"]*" + 1)",sep="")),side=2,line=-1,cex=1.5,outer=TRUE)
mtext(paste("Performance temperature (°C)"),side=1,line=1,cex=1.5,outer=TRUE)
...
#2021
par(mfrow=c(3,1),mar=c(4.5,4.5,2,1.75),oma=c(1,3,3,1.5))
plot(x=c(as.numeric(days.df[1,1:5])),Days2021Mns[3:7,1],col="white",xlim=c(0,35),ylim=c(0,5),
     ylab="",xlab="",cex.lab=1.5,cex.main=1.5, main="Experiment 1A",xaxt='n')
errbar(x=c(as.numeric(days.df[1,1:5])),y=Days2021Mns[3:7,1],yplus=Days2021Mns[3:7,1]+Days2021SEs[3:7,1],yminus=Days2021Mns[3:7,1]-Days2021SEs[3:7,1],col=col[1],errbar.col=col[1],
       pch=15,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[1,1:5])),y=Days2021Mns[3:7,1],col=col[1],lty=1,lwd=2)
errbar(x=c(as.numeric(days.df[2,1:5])),y=Days2021Mns[3:7,2],yplus=Days2021Mns[3:7,2]+Days2021SEs[3:7,2],yminus=Days2021Mns[3:7,2]-Days2021SEs[3:7,2],col=col[2],errbar.col=col[2],
       pch=17,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[2,1:5])),y=Days2021Mns[3:7,2],col=col[2],lty=2,lwd=2)
errbar(x=c(as.numeric(days.df[3,1:5])),y=Days2021Mns[3:7,3],yplus=Days2021Mns[3:7,3]+Days2021SEs[3:7,3],yminus=Days2021Mns[3:7,3]-Days2021SEs[3:7,3],col=col[3],errbar.col=col[3],
       pch=16,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[3,1:5])),y=Days2021Mns[3:7,3],col=col[3],lty=4,lwd=2)
errbar(x=c(as.numeric(days.df[4,1:5])),y=Days2021Mns[3:7,4],yplus=Days2021Mns[3:7,4]+Days2021SEs[3:7,4],yminus=Days2021Mns[3:7,4]-Days2021SEs[3:7,4],col=col[4],errbar.col=col[4],
       pch=18,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[4,1:5])),y=Days2021Mns[3:7,4],col=col[4],lty=3,lwd=2)
...
errbar(x=c(as.numeric(days.df[1,1:5])),y=Days2022Mns[4:8,1],yplus=Days2022Mns[4:8,1]+Days2022SEs[4:8,1],yminus=Days2022Mns[4:8,1]-Days2022SEs[4:8,1],col=col[1],errbar.col=col[1],
       pch=15,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[1,1:5])),y=Days2022Mns[4:8,1],col=col[1],lty=1,lwd=2)
errbar(x=c(as.numeric(days.df[2,1:5])),y=Days2022Mns[4:8,2],yplus=Days2022Mns[4:8,2]+Days2022SEs[4:8,2],yminus=Days2022Mns[4:8,2]-Days2022SEs[4:8,2],col=col[2],errbar.col=col[2],
       pch=17,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[2,1:5])),y=Days2022Mns[4:8,2],col=col[2],lty=2,lwd=2)
errbar(x=c(as.numeric(days.df[3,1:5])),y=Days2022Mns[4:8,3],yplus=Days2022Mns[4:8,3]+Days2022SEs[4:8,3],yminus=Days2022Mns[4:8,3]-Days2022SEs[4:8,3],col=col[3],errbar.col=col[3],
       pch=16,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[3,1:5])),y=Days2022Mns[4:8,3],col=col[3],lty=4,lwd=2)
errbar(x=c(as.numeric(days.df[4,1:5])),y=Days2022Mns[4:8,4],yplus=Days2022Mns[4:8,4]+Days2022SEs[4:8,4],yminus=Days2022Mns[4:8,4]-Days2022SEs[4:8,4],col=col[4],errbar.col=col[4],
       pch=18,cex=2.5,add=TRUE)
lines(x=c(as.numeric(days.df[4,1:5])),y=Days2022Mns[4:8,4],col=col[4],lty=3,lwd=2)
axis(1,at=seq(from=0,to=35,by=5),labels=FALSE,tick=TRUE)
...
plot(c(as.numeric(days.df[1,1]),as.numeric(days.df[1,5])), FilterRate[1:2, 1], col="white", pch=16, xlab="Day of experiment", ylab="", ylim=c(0,7),xlim=c(0,35),cex=1.5,cex.lab=2.25,cex.main=1.5, main="Zoospore production (Expt. 2)")
errbar(c(as.numeric(days.df[1,1]),as.numeric(days.df[1,5])), FilterRate[1:2, 1], yminus=FilterRate[1:2, 1]-FilterRatese[1:2, 1], yplus=FilterRate[1:2, 1]+FilterRatese[1:2, 1],add=TRUE, errbar.col=col[1], col=col[1], pch=15,cex=2.5,cex.lab=1.5,cex.main=1.5)
...
legend(x=27,y=7,title="PerfTemp",c("10 °C","15 °C","20 °C","25 °C"),col=col,pch=c(15,17,16,18),lty=c(1,2,4,3),bty="n")
mtext(LETTERS[3], side=3, adj=-0.15, line=0, cex=1)
mtext(expression(paste("Ln(Bd Z"["e"]*" + 1)",sep="")),side=2,line=-1,cex=1.5,outer=TRUE)
...
par(mfrow=c(2,1),mar=c(4.5,2,1,1),oma=c(1,3,3,1.5))
### Swabs Vs. Filters ###
plot(c(as.numeric(perfTemp.df[1,1:4])), group_meanFilter,main=NULL, xlab="",
     ylab="", ylim=c(0,8), xlim=c(9.8,25.2), col="white",cex=1.5,cex.lab=1.5,cex.main=1.5,xaxt='n')
errbar(c(as.numeric(perfTemp.df[1,1:4])), group_meanSwab, yminus=group_meanSwab-group_seSwab, yplus=group_meanSwab+group_seSwab,pch=1,cex=2,cex.lab=1.5,cex.main=1.5, add=TRUE)
lines(c(as.numeric(perfTemp.df[1,1:4])), group_meanSwab, lwd=2)
errbar(c(as.numeric(perfTemp.df[2,1:4])), FilterRate[1,1:4], yminus=FilterRate[1,1:4]-FilterRatese[1,1:4], yplus=FilterRate[1,1:4]+FilterRatese[1,1:4], add=TRUE, errbar.col="black", pch=0, col="black",cex=2,cex.lab=1.5,cex.main=1.5)
lines(c(as.numeric(perfTemp.df[2,1:4])), FilterRate[1,1:4], col="black", lty=2,cex=1.5,cex.lab=1.5,cex.main=1.5, lwd=2)
legend(x=19.5,y=8, legend=c("Filter Bd","Swab Bd"), col=c("black", "black"), lty=c(2,1), pch=c(0,1),bty="n")
axis(1,at=seq(from=10,to=25,by=5),labels=FALSE,tick=TRUE)
mtext(LETTERS[1], side=3, adj=-0.15, line=0, cex=1)

plot(c(as.numeric(perfTemp.df[1,1:4])), zooData2[1:4, 1], col="white", pch=16, xlab="Performance temperature (°C)", ylab="",# main="Zoospores/min. by Acclimation Temp. (°C at Day 7)"
...
legend(x=20.5,y=8,title="AccTemp",c("10 °C","15 °C","20 °C"),col=col,pch=c(0,2,1),lty=c(1,2,3),bty="n")
mtext(LETTERS[2], side=3, adj=-0.15, line=0, cex=1)
...
TempData<-read.csv(file.choose(),header=TRUE) # File name: "Experiment1&2TemperatureData"
...
plot(treat10C,mn10Temp,col="white",ylim=c(7,28),xlim=c(7,28),main="Experiment 1",xlab="Target Temperature (°C)",ylab="Actual Temperature (°C)")
...
plot(treat10C,mn10Temp,col="white",ylim=c(7,28),xlim=c(7,28),main="Experiment 2",xlab="Target temperature (°C)",ylab="Actual temperature (°C)",yaxt='n')
errbar(treat10C,mn10Temp,yplus=mn10Temp+SD10C,yminus=mn10Temp-SD10C,col=col[1],errbar.col=col[1],pch=15,cex=1.2,add=TRUE)
errbar(treat15C,mn15Temp,yplus=mn15Temp+SD15C,yminus=mn15Temp-SD15C,col=col[2],errbar.col=col[2],pch=17,cex=1.2,add=TRUE)
errbar(treat20C,mn20Temp,yplus=mn20Temp+SD20C,yminus=mn20Temp-SD20C,col=col[3],errbar.col=col[3],pch=16,cex=1.2,add=TRUE)
errbar(treat25C,mn25Temp,yplus=mn25Temp+SD25C,yminus=mn25Temp-SD25C,col=col[4],errbar.col=col[4],pch=18,cex=1.2,add=TRUE)
...
mtext(LETTERS[2], side=3, adj=-0.15, line=0, cex=1)
mtext(paste("Target temperature (°C)"),side=1,line=2,cex=1.5,outer=TRUE)
mtext(paste("Actual temperature (°C)"),side=2,line=2,cex=1.5,outer=TRUE)
...
massData<-read.csv(file.choose()) # File name "Experiment1&2CombinedMassData"

head(massData)

massMn<-tapply(massData$InitialMass,list(massData$Experiment),mean)
massSD<-tapply(massData$InitialMass,list(massData$Experiment),sd)
massLng<-tapply(massData$InitialMass,list(massData$Experiment),length)
...
model1<-lm(InitialMass~Experiment,data=massData)
summary(model1)
Anova(model1,test="F")
...
### Table 2 with family=binomial for Experimetn 1A
BinomModel4<-glmmTMB(BdStatus~AccTemp*PerfTemp*TimeSinceExposure + (1|PerfInc/FrogID) + (1|AccInc), family=binomial,
                     data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0))
summary(BinomModel4)
Anova(BinomModel4)
#View(Anova(BinomModel4))

BinomModel4<-glmmTMB(BdStatus~AccTemp*PerfTemp+AccTemp*TimeSinceExposure+PerfTemp*TimeSinceExposure + (1|PerfInc/FrogID) + (1|AccInc), family=binomial,
                     data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0))
summary(BinomModel4)
Anova(BinomModel4)

BinomModel4<-glmmTMB(BdStatus~PerfTemp+AccTemp*TimeSinceExposure + (1|PerfInc/FrogID) + (1|AccInc), family=binomial,
                     data=subset(IndBd2021,TimeSinceExposure>=0 & DayOfExpo==0))
summary(BinomModel4)
Anova(BinomModel4)

### Table 2 with family=binomial for Experiment 2
BinomModel4<-glmmTMB(BdStatus~AccTemp*PerfTemp*TimeSinceExposure + (1|PerfInc/FrogID) + (1|AccInc), family=binomial,
                     data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0))
summary(BinomModel4)
Anova(BinomModel4)
#View(Anova(BinomModel4))
...
BinomModel4<-glmmTMB(BdStatus~TimeSinceExposure+AccTemp*PerfTemp + (1|PerfInc/FrogID) + (1|AccInc), family=binomial,
                     data=subset(IndBd2022,TimeSinceExposure>=0 & DayOfExpo==0))
summary(BinomModel4)
Anova(BinomModel4)
...
### Table 3 with family=binomial for Experiment 1B

### DayOfExpo=-7; TimeSinceExpo==7 or 14
BinomModel4<-glmmTMB(BdStatus~AccTemp*PerfTemp*TimeSinceExposure +(1|AccInc)+ (1|PerfInc), family=binomial,
                    data=subset(IndBd2021,DayOfExpo== -7 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(BinomModel4)
Anova(BinomModel4)

### DayOfExpo=0; TimeSinceExpo==7 or 14
BinomModel4<-glmmTMB(BdStatus~AccTemp*PerfTemp*TimeSinceExposure +(1|AccInc)+ (1|PerfInc) , family=binomial,
                     data=subset(IndBd2021,DayOfExpo== 0 & (TimeSinceExposure==7|TimeSinceExposure==14)  & (PerfTemp==10|PerfTemp==20)))
summary(BinomModel4)
Anova(BinomModel4)
...
###############################
### Directionality of shift ###
###############################

### Expt. 1A
# Decrease 20 -> 10
DecreaseModel1<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|FrogID),data=subset(IndBd2021, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==10)) 
summary(DecreaseModel1)
Anova(DecreaseModel1,test="F")

# Increase 10 -> 20
IncreaseModel1<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|FrogID),data=subset(IndBd2021, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==20)) 
summary(IncreaseModel1)
Anova(IncreaseModel1,test="F")

### Expt. 2
# Decrease  20 -> 10
DecreaseModel2<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==10 & AccTemp!=15)) 
summary(DecreaseModel2)
Anova(DecreaseModel2,test="F")

# Increase 10 -> 20
IncreaseModel2<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==20 & AccTemp!=15)) 
summary(IncreaseModel2)
Anova(IncreaseModel2,test="F")

##############################
### Distance of Temp Shift ###
##############################

### Expt. 2
# Small cold shift 15 -> 10
DecreaseModel1<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==10 & (AccTemp==15|AccTemp==10))) 
summary(DecreaseModel1)
Anova(DecreaseModel1,test="F")

# Large cold shift 20 -> 10
DecreaseModel2<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==10 & (AccTemp==20|AccTemp==10))) 
summary(DecreaseModel2)
Anova(DecreaseModel2,test="F")

# Small warm shift 15 - 20
IncreaseModel1<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==20 & (AccTemp==20|AccTemp==15))) 
summary(IncreaseModel1)
Anova(IncreaseModel1,test="F")

# Large warm shift 10 -> 20
IncreaseModel2<-lmer(LnSwabBd~AccTemp+TimeSinceExposure+(1|PerfInc/FrogID),data=subset(IndBd2022, (TimeSinceExposure==7 | TimeSinceExposure==14) & DayOfExpo==0 & PerfTemp==20 & (AccTemp==20|AccTemp==10))) 
summary(IncreaseModel2)
Anova(IncreaseModel2,test="F")
